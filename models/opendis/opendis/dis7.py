...
#     def serialize(self, outputStream):
#         """serialize the class """
#         super( Environment, self).serialize(outputStream); 
...
#     def parse(self, inputStream):
#         """"Parse a message. This may recursively call embedded objects.""" 
#         super( Environment, self).parse(inputStream); 
...
class Pdu( PduSuperclass ):
    ...
    def serialize(self, outputStream):
        ...
        outputStream.write_unsigned_byte(self.pduStatus);
        outputStream.write_unsigned_byte(self.padding);
        # outputStream.write_utf(self.device);
...
class EntityStatePdu( EntityInformationFamilyPdu ):
    ...
    def __init__(self):
        ...
        """ initialize value """
        attack = ""
        self.attack = attack.encode('utf-8')
        """Adddd attack for prototype"""
        self.label = 0
        """labels"""
    ...
    def serialize(self, outputStream):
        ...
        for anObj in self.variableParameters:
            anObj.serialize(outputStream)
        outputStream.write_utf(self.attack);
...
class Environment(Pdu):
    ...
    def __init__(self):
        ...
        #---- Everything below is added for IoT prototype-----# 
        device = "none"
        ...
        """Created humidity"""
        condition = "none"
        self.condition = condition.encode('utf-8')
        """Created condition"""
        self.temp_status = 0
        # """temperature status"""
        attack = "none"
        ...
        """created label"""
        self.pduType = 70
        """Added PDU type for sim"""

    def serialize(self, outputStream):
        """serialize the class """
        super( Environment, self).serialize(outputStream); 
        outputStream.write_float(self.environmentType);
        outputStream.write_unsigned_short(self.length);
        outputStream.write_unsigned_byte(self.index);
        outputStream.write_unsigned_byte(self.padding);
        #--- added for IoT Prototype --- # 
        outputStream.write_utf(self.device);
        outputStream.write_double(self.temperature);
        outputStream.write_double(self.pressure);
        outputStream.write_double(self.humidity); 
        outputStream.write_utf(self.condition);
        outputStream.write_int(self.temp_status);
        outputStream.write_utf(self.attack);
        outputStream.write_int(self.label);
    ...
    def parse(self, inputStream):
        """"Parse a message. This may recursively call embedded objects.""" 
        super( Environment, self).parse(inputStream); 
        self.environmentType = inputStream.read_float();
        self.length = inputStream.read_unsigned_short();
        self.index = inputStream.read_unsigned_byte();
        self.padding = inputStream.read_unsigned_byte();
        # --- added for IoT Prototype --- #
        self.device = inputStream.read_string();
        self.temperature = inputStream.read_double();
        self.pressure = inputStream.read_double();
        self.humidity = inputStream.read_double();
        self.condition = inputStream.read_string(); 
        self.temp_status = inputStream.read_int();
        self.attack = inputStream.read_string();
        self.label = inputStream.read_int();


class Modbus(Pdu):
    """PDU for the modbus for the prototype of IoT """
    def __init__(self):
        """ Initializer for Environment"""
    ...
    def serialize(self, outputStream):
        """"Parse a message. This may recursively call embedded objects.""" 
        super( Modbus, self).serialize(outputStream); 
        outputStream.write_double(self.fc1);
        outputStream.write_double(self.fc2);
        outputStream.write_double(self.fc3);
        outputStream.write_double(self.fc4);
        outputStream.write_utf(self.attack);
        outputStream.write_int(self.label); 

    def parse(self, inputStream):
        """"Parse a message. This may recursively call embedded objects.""" 
        super( Modbus, self).parse(inputStream);
        self.fc1 = inputStream.read_double(); 
        self.fc2 = inputStream.read_double();
        self.fc3 = inputStream.read_double(); 
        self.fc4 = inputStream.read_double();
        self.attack = inputStream.read_utf();
        self.label = inputStream.read_int();
...
class Garage( Pdu ):
    ...
    def serialize(self, outputStream):
        """"Parse a message. This may recursively call embedded objects.""" 
        super( Garage, self).serialize(outputStream); 
        outputStream.write_utf(self.door_state);
        outputStream.write_int(self.sphone);
        outputStream.write_utf(self.attack);
        outputStream.write_int(self.label); 

    def parse(self, inputStream):
        """"Parse a message. This may recursively call embedded objects.""" 
        super( Garage, self).parse(inputStream);
        self.door_state = inputStream.read_utf();
        self.sphone = inputStream.read_int();
        self.attack = inputStream.read_utf();
        self.label = inputStream.read_int();
...
class Light( Pdu ):
    ...
    def __init__(self):
        ...
        """Door state"""
        status = "none"
        self.light_status = status.encode('utf-8')
        """sphone"""
        attack = "none"
        self.attack = attack.encode('utf-8')
        """attack"""
    ...
    def serialize(self, outputStream):
        ...
        outputStream.write_int(self.motion_status);
        outputStream.write_utf(self.light_status);
        outputStream.write_utf(self.attack);
        outputStream.write_int(self.label); 
    ...
    def parse(self, inputStream):
        ...
        self.motion_status = inputStream.read_int();
