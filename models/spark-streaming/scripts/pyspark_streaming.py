...
class SparkStructuredStreaming:
    ...
    def receive_kafka_message(self):
        ...
        if fridgeDF.isStreaming and not fridgeDF.isEmpty():
        ...
        # -----------------------------------------------
        # serialGarageDF = garageDF.select("vlue")
        ...
        # if expandedGarageDF.isStreaming and not expandedGarageDF.isEmpty():
        #     # save to cassandra
        ...
        # if expandedGpsDF.isStreaming and not expandedGpsDF.isEmpty():
        #     # save to cassandra
        #     cassandraGpsConfig = {
        #         "keyspace": "dis",
        #         "table": "gps_table",
        ...
        # if expandedLightDF.isStreaming and not expandedLightDF.isEmpty():
        #     # save to cassandra
        ...
        # if expandedModbusDF.isStreaming and not expandedModbusDF.isEmpty():
        #     # save to cassandra
        ...
        # if expandedThermostatDF.isStreaming and not expandedThermostatDF.isEmpty():
        ...
        # if expandedWeatherDF.isStreaming and not expandedWeatherDF.isEmpty():
        #     # save to cassandra
