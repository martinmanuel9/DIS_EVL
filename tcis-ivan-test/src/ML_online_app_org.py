...
class MachineLearning():
    ...
    def __init__(self, threshold: int, layer: str, noise=0.1, mode=0, window=1000, sample_period=10000,
                 strict_online_learning_length=30, stream_sample_window=5000, ae_pred_window_size=3,
    ...
    def load_models_attack_cls(self):
        ...
        self.attack_cls_scaler = joblib.load('attack_cls/mlp0.pkl')
    ...
    def attack_classification(self, df):
        ...
        # Attack: {colored(self.attack_val_map[y_cls[0]], 'green')}
        {'-'*40}
        """
